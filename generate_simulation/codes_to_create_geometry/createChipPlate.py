...
class ChipPlateModel():
    ...
    def createSetsandSections(self):
        ...
        # Creating Sections
        self.m.HomogeneousSolidSection(material='Inconel718', name=self.SectionName, thickness=None)
        # self.m.EulerianSection(data={'da718-1': 'Inconel718'}, name=self.SectionName)
