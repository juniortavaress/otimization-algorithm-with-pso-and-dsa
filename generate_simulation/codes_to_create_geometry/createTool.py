...
class ToolModel():
    ...
    def createMesh(self):
        ...
        self.p.seedEdgeByBias(biasMethod=SINGLE, constraint=FINER, end1Edges=self.p.edges.getSequenceFromMask(('[#2242490 ]', ), ), end2Edges=self.p.edges.getSequenceFromMask(('[#480a40 ]', ), ), maxSize=0.03, minSize=0.01)
        self.p.seedEdgeBySize(constraint=FINER, deviationFactor=0.1, edges=self.p.edges.getSequenceFromMask(('[#3190d005 ]', ), ), minSizeFactor=0.1, size=0.003)
