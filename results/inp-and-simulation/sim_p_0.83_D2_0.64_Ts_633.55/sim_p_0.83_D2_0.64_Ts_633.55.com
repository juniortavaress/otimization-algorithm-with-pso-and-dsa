...
options = {
    ...
    'input':'sim_p_0.83_D2_0.64_Ts_633.55',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'sim_p_0.83_D2_0.64_Ts_633.55',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
    'usub_lib_dir':'s:\\Junior\\abaqus-with-python\\otimization-scripts\\otimization-algorithm-with-pso-and-dsa\\results\\inp-and-simulation\\sim_p_0.83_D2_0.64_Ts_633.55',
    'visco':OFF,
    'xplSelect':OFF,
}
