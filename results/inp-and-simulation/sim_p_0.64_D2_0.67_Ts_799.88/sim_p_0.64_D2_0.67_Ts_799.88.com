...
options = {
    ...
    'input':'sim_p_0.64_D2_0.67_Ts_799.88',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'job':'sim_p_0.64_D2_0.67_Ts_799.88',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
    'usub_lib_dir':'s:\\Junior\\abaqus-with-python\\otimization-scripts\\otimization-algorithm-with-pso-and-dsa\\results\\inp-and-simulation\\sim_p_0.64_D2_0.67_Ts_799.88',
    'visco':OFF,
    'xplSelect':OFF,
}
