...
class AssemblyModel():
    ...
    def setBoundaryConditionsAndPredefinedFields(self):
        ...
        self.m.VelocityBC(amplitude=UNSET, createStepName='CuttingStep', distributionType=UNIFORM, fieldName='', localCsys=None, name='BC-WorkpieceBottom', region=self.m.rootAssembly.instances['Eulerian-1'].sets['WorkpieceBottom'], v1=166.67, v2=0.0, v3=0.0, vr1=0.0, vr2=0.0, vr3=0.0)
        ...
        self.m.Velocity(distributionType=MAGNITUDE, field='', name='cuttingMove', omega=0.0, region=self.m.rootAssembly.instances['Eulerian-1'].sets['WorkpieceDomain'], velocity1=166.67)
